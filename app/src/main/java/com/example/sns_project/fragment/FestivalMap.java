...
public class FestivalMap extends Fragment implements OnMapReadyCallback {
    ...
    private static final String TAG = FestivalMap.class.getSimpleName();
    ...
    public static ArrayList<TourDTO> apiParserSearch() throws Exception
    {
        ...
        String xpos = null, ypos = null, name = null, addr1 = null, firstimage = null, eventstartdate = null, eventenddate = null;
        while (event_type != XmlPullParser.END_DOCUMENT)
        {
            if (event_type == XmlPullParser.START_TAG)
            {
