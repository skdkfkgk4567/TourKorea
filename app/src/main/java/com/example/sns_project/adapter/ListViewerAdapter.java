...
public class ListViewerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView title = (TextView) convertView.findViewById(R.id.placeNameText) ;
        TextView Context = (TextView) convertView.findViewById(R.id.addressTextView) ;
