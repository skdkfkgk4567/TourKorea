...
public class UserListAdapter extends RecyclerView.Adapter<UserListAdapter.MainViewHolder> {
    private ArrayList<com.example.sns_project.UserInfo> mDataset;
    ...
    public UserListAdapter(Activity activity, ArrayList<com.example.sns_project.UserInfo> myDataset) {
    ...
    public void onBindViewHolder(@NonNull final MainViewHolder holder, int position) {
        ...
        com.example.sns_project.UserInfo userInfo = mDataset.get(position);
